...
[Descargar este documento en PDF](unidad7.pdf){.btn .btn-primary}
...
Para su construcción, como siempre, partimos los datos. Estos tienen que contener las variables Edad (grupos etarios regulares cada 5 años), Sexo (mujeres y varones) y población de cada subgrupo. Similar a esta forma:
