...
base |> 
  summarise(
    ...
    ic_lower = MeanCI(datos$EDAD_DIAGNOSTICO)[2],
    ic_upper = MeanCI(datos$EDAD_DIAGNOSTICO)[3]
  )
```
...
Utilizaremos un dataset que viene preparado para mostras el uso de la función `anova_test()` 
...
- cor.mat() y sus funciones anexas
